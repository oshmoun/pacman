...
**How to use Gerrit [Guide] (https://github.com/PAC-man/android_vendor_pac/blob/pac-5.1-twrp/docs/HowToUseGerrit.md)**

**Getting Started: Preparing and building [Linux Guide] (https://github.com/PAC-man/android_vendor_pac/blob/pac-5.1-twrp/docs/PrepareForBuildLinux.md) or [Mac OS Guide] (https://github.com/PAC-man/android_vendor_pac/blob/pac-5.1-twrp/docs/PrepareForBuildMac.md)**

**Device isn't supported? Not a problem! [Read] (https://github.com/PAC-man/android_vendor_pac/blob/pac-5.1-twrp/docs/BecomeAMaintainer.md)**
